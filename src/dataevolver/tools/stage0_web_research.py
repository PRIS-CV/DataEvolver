...
```bash
python -m dataevolver.tools.stage0_web_research add-evidence \\
...
```bash
python -m dataevolver.tools.stage0_web_research next-iteration --session-dir "{session_dir}"
```

5. Finalize local artifacts:

```bash
python -m dataevolver.tools.stage0_web_research finalize --session-dir "{session_dir}"
```
...
4. Generate Blender-backed samples in a private experiment package that implements this schema.
