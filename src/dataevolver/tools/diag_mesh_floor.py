...
Usage:
    python src/dataevolver/diag_mesh_floor.py
    python src/dataevolver/diag_mesh_floor.py --ids obj_003 obj_007
    python src/dataevolver/diag_mesh_floor.py --output-dir /tmp/diag
"""
