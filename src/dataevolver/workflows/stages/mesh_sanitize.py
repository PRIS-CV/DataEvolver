...
Usage:
    python -m dataevolver.workflows.stages.mesh_sanitize                    # all objects
    python -m dataevolver.workflows.stages.mesh_sanitize --dry-run          # QC only, no deletion
    python -m dataevolver.workflows.stages.mesh_sanitize --ids obj_001 obj_003
    python -m dataevolver.workflows.stages.mesh_sanitize --conf-auto 0.78 --conf-review 0.55
"""
