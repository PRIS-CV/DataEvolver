...
Reads render metadata from .dataevolver/runtime/renders/*/metadata.json
Outputs:
  .dataevolver/runtime/image_metadata.json      — unified metadata
  .dataevolver/runtime/pairs_train.csv          — 80% training pairs
  .dataevolver/runtime/pairs_val.csv            — 10% validation pairs
  .dataevolver/runtime/pairs_test.csv           — 10% test pairs
