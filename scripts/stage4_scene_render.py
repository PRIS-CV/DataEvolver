...
def render_object(asset_path: str, obj_id: str, output_dir: str,
    ...
    if not should_preserve_materials:
        ...
        raw_roughness_add = float(control_material.get("roughness_add", 0.0))
        raw_specular_add = float(control_material.get("specular_add", 0.0))
        ...
        if has_image_texture and not allow_textured_surface:
            ...
            specular_add = 0.0
            surface_adjustment = {
                "raw_roughness_add": round(raw_roughness_add, 4),
                "raw_specular_add": round(raw_specular_add, 4),
                "roughness_add": 0.0,
                "specular_add": 0.0,
            ...
            roughness_add = raw_roughness_add
            specular_add = raw_specular_add
            surface_adjustment = {
                "raw_roughness_add": round(raw_roughness_add, 4),
                "raw_specular_add": round(raw_specular_add, 4),
                "roughness_add": round(roughness_add, 4),
                "specular_add": round(specular_add, 4),
        ...
        hsv_adjustment = resolve_material_hsv_adjustment(
            control_material,
            has_image_texture,
            float(control_material.get("value_scale", 1.0)),
        )
        adjust_material_hsv(
            mesh_objects,
