...
for obj_id in "${OBJECTS[@]}"; do
  for yaw in 000 045 090 135 180 225 270 315; do
    d="<repo-root>/runtime/new_asset_force_rot8_20260429_203842/trainready/views/${obj_id}/yaw${yaw}_depth.png"
    n="<repo-root>/runtime/new_asset_force_rot8_20260429_203842/trainready/views/${obj_id}/yaw${yaw}_normal.png"
    if [ ! -f "$d" ] || [ ! -f "$n" ]; then
