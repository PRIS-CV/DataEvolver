...
VLM_MODEL_PATH = "/huggingface/model_hub/Qwen3.6-27B"
...
def _resolve_reference_image(obj_id, profile_cfg, renders_dir):
    ...
    if ref_dir is None:
        ...
        # renders_dir = <large-file-root>
        # -> ref_dir = <large-file-root>
...
def load_vlm(device: str = "cuda:0"):
    ...
    _vlm_model = Qwen3_5ForConditionalGeneration.from_pretrained(
        VLM_MODEL_PATH,
